...
# for brood years at the upper Battle Creek rotary screw trap. The data comes from 4 queries
...
# Load data sets
chn1 <- read_excel("C:/Users/mschraml/Desktop/R Studio Projects/Report Data/UBC Report Data CHN.xlsx", 
...
lfc <- pad(lfc, interval = "day",
           start_val = lubridate::ymd("2019-03-01"),
