...
cat <- read.csv("BOR Data.csv")
#cat<- read.csv("C:/Users/nwingerter/OneDrive - DOI/Desktop/BOR Biweekly Reports/2022 Weeks 13-14/BOR Data.csv")
sid <-  read.csv("LCC SampleID.csv")
#sid <- read.csv("C:/Users/nwingerter/OneDrive - DOI/Desktop/BOR Biweekly Reports/2022 Weeks 13-14/LCC/Data/LCC SampleID.csv")
...
fcs <- cat1 %>% filter(BroodYear == by1, FWSRace == "F")
...
passage <- merge(passage, fcs.p, all=T)
...
fl.f <- fl.f %>% select(Date, minimum, maximum)
...
#temp <- read.csv("C:/Users/nwingerter/OneDrive - DOI/Desktop/BOR Biweekly Reports/2022 Weeks 13-14/LCC/Data/CLEAR CREEK NEAR IGO (temp).csv")
flow <- read.csv("CLEAR CREEK NEAR IGO (flow).csv")
#flow <- read.csv("C:/Users/nwingerter/OneDrive - DOI/Desktop/BOR Biweekly Reports/2022 Weeks 13-14/LCC/Data/CLEAR CREEK NEAR IGO (flow).csv")
...
names(t.f.p.fl)[2] <- 'Discharge volume (cfs)'
names(t.f.p.fl)[3] <- 'Water temperature (C)'
names(t.f.p.fl)[4] <- 'Water turbidity (NTU)'

# Run this Code to output the Excel file
write.csv(t.f.p.fl, "C:/Users/nwingerter/OneDrive - DOI/Desktop/BOR Biweekly Reports/2022 Weeks 13-14/LCC/Output/BOR Daily Passage and FL LCC.csv", row.names = FALSE)
