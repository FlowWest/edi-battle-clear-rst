...
# Load data sets
chn1 <- read_excel("C:/Users/mschraml/Desktop/R Studio Projects/Report Data/LCC Report Data CHN.xlsx", 
...
lfc1 <- read_excel("C:/Users/mschraml/Desktop/R Studio Projects/Report Data/LCC Report Data LFCS.xlsx", 
                  col_types = c("text", "text", "date", 
                                "numeric", "text", "numeric", "numeric", 
                                "text", "text", "text", "numeric", 
                                "numeric", "numeric", "text", "text", 
...
wcs1 <- read_excel("C:/Users/mschraml/Desktop/R Studio Projects/Report Data/LCC Report Data WCS.xlsx", 
                  col_types = c("text", "text", "date", 
                                "numeric", "text", "numeric", "numeric", 
                                "text", "text", "text", "numeric", 
                                "numeric", "numeric", "text", "text", 
...
rbt1 <- read_excel("C:/Users/mschraml/Desktop/R Studio Projects/Report Data/LCC Report Data RBT.xlsx", 
                  col_types = c("text", "text", "date", 
                                "numeric", "text", "numeric", "numeric", 
...
fcs <- select(fcs, SampleDate, BroodYear, FWSRace, RCatch)
