...
# At the upper Clear Creek RST site.
...
# Select for just UCC data
catch <- catch %>% filter(StationCode == "UCC") 
...
############## Calculate the biweekly passage and the total passage index ##############
# Calculate the biweekly passage Index
...
############## Add data to biweekly Table ##############
biweekly[1, 6] <- lfcs.biweekly.passage.2          # biweekly passage Index
...
brood.year[2, 7] <- round(rbt.Alcl.90a.d, 0)        # brood year Lower 90% confidence limit
brood.year[3, 7] <- round(rbt.Aucl.90a.d, 0)        # brood year Upper 90% confidence limit
...
brood.year[2, 8] <- round(rbt.Alcl.90a.e, 0)        # brood year Lower 90% confidence limit
brood.year[3, 8] <- round(rbt.Aucl.90a.e, 0)        # brood year Upper 90% confidence limit
...
brood.year[2, 5] <- round(lfcs.Alcl.90a.d, 0)        # brood year Lower 90% confidence limit
brood.year[3, 5] <- round(lfcs.Aucl.90a.d, 0)        # brood year Upper 90% confidence limit
...
############## Calculate the the brood year passage index ##############
# Calculate the brood year passage Index
...
write.csv(l, "C:/Users/mschraml/Desktop/ROutput/UCC Bootstraps.csv", row.names = FALSE)
